	...
	function houzez_prop_carousel_v6($atts, $content = null)
	{
		...
		<div class="property-carousel-module houzez-carousel-arrows-<?php echo esc_attr($token); ?> houzez-carousel-cols-<?php echo esc_attr($slides_to_show); ?> property-carousel-module-v5">
			...
			<div class="property-carousel-buttons-wrap">
				...
				<button type="button" class="slick-prev-js-<?php echo esc_attr($token); ?> slick-prev btn-primary-outlined">❮</button>
				<button type="button" class="slick-next-js-<?php echo esc_attr($token); ?> slick-next btn-primary-outlined">❯</button>
				<?php } ?>
				<?php if($all_url != '') { ?>
